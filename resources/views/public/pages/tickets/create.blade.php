            ...
            <div class="card my-4 border-0">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                        <h1 class="text-white text-capitalize ps-3">Create New Ticket</h1>
                    </div>
                </div>
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form method="POST" action="{{ route('tickets.store') }}" class="ticket-form">
                                ...
                                <div class="form-group custom-form-group">
                                    ...
                                    <div class="select-wrapper">
                                        <select class="form-control" id="category" name="category" required>
                                            ...
                                            <option value="HR Issue" {{ old('category') == 'HR Issue' ? 'selected' : '' }}>HR Issue</option>
                                            <option value="Request" {{ old('category') == 'Request' ? 'selected' : '' }}>Request</option>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <div class="form-group custom-form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Please provide detailed information about your ticket..." required>{{ old('description') }}</textarea>
                                    @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row action-buttons">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('tickets.index') }}" class="btn cancel-btn w-100">
